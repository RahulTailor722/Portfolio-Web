...
const QuoteIcon = ({ size = 44 }) => (
  <svg width={size} height={Math.round(size * 0.78)} viewBox="0 0 36 28" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
const ArrowLeft = () => (
  <svg width="20" height="9" viewBox="0 0 25 10" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <div className="container">
        <div className={styles.head}>
          ...
          <h2 className={`section-title ${styles.title} tp_title_anim`}>
            Clients, in <span className="text-accent">their words</span>
          </h2>
          <p className={`${styles.headNote} tp_fade_anim`} data-delay="0.3">
            Real projects, real teams — from Shopify storefronts in Australia
            to consultancies in the Netherlands.
          </p>
        </div>

        <div
          className={`${styles.quotePanel} tp_fade_anim`}
          data-delay="0.2"
        ...
        >
          ...
          <div key={current} className={styles.quoteInner}>
            ...
            <div className={styles.authorRow}>
              ...
              <div className={styles.tagCol}>
                <span className={styles.projectTag}>{t.project}</span>
