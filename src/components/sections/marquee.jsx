...
const Marquee = () => {
  ...
  //
  // Rendering one copy and cloning the rest at runtime was tried (to stop
  // crawlers reading this keyword list four times) and reverted — it made the
  // track depend on an effect firing, which is one more thing that can go
